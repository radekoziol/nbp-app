...
public class CurrencyStats {
    ...
    */
    ...
    public void getMinAndMaxOf(String currency) throws IOException {
        ...
        Comparator<currencyPrice.Currency.Rates> byMid = Comparator.comparing(currencyPrice.Currency.Rates::getMid);
    ...
    public Map<String, Float> getAverageRateOf(List<currencyPrice.Currency> currencies, String rate) {
        ...
        switch (rate.toLowerCase()) {
            ...
            case "bid": {
                ...
                for(currencyPrice.Currency currency : currencies){
                    int counter = 0;
                    for(currencyPrice.Currency.Rates rate0 : currency.getRates()){
            ...
            case "ask":{
                ...
                for(currencyPrice.Currency currency : currencies){
                    int counter = 0;
                    for(currencyPrice.Currency.Rates rate1 : currency.getRates()){
            ...
            case "mid":{
                ...
                for(currencyPrice.Currency currency : currencies){
                    int counter = 0;
                    for(currencyPrice.Currency.Rates rate2 : currency.getRates()){
        ...
        for(currencyPrice.Currency currency : currencies) {
            int counter = 0;
            for (currencyPrice.Currency.Rates rate4 : currency.getRates()) {
    ...
    public List<Float> getMinRateOf(List<currencyPrice.Currency> currencies, String rate){
        return getRateOf(currencies,rate,Comparator.<Float>naturalOrder().reversed());
    }

    public List<Float> getMaxRateOf(List<currencyPrice.Currency> currencies, String rate){
        return getRateOf(currencies,rate,Comparator.<Float>naturalOrder());
    }

    public List<Float> getRateOf(List<currencyPrice.Currency> currencies, String rate, Comparator<Float> comparator){
